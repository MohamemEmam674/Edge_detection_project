...
always @ (posedge clk ,con_done ) begin
     ...
     p4 <= (pixel_counter ==index_counter+ 0 )?rom_data : p4;
   ...
   assign rom_address =(pixel_counter<index_counter+2)? 
   pixel_counter+raw_counter:pixel_counter+raw_counter+125;
    ...
    always @(posedge clk,con_done) begin 
        if(reset) begin
           ...
           if (pixel_counter==index_counter+3) begin
